...
module.exports = {
  ...
  datastores: {
    ...
    ***************************************************************************/
    default: {
      ...
      database: 'coffee_mongo' //optional
  ...
  security: {
    ...
    ***************************************************************************/
    ...
    cors: {
      ...
      allowOrigins: [
        'https://crm.dobryicoffee.ru',
        'https://tgapp.dobryicoffee.ru',
        'https://service.dobryicoffee.ru',
        'http://localhost:3000'
      ],
      // allowAnyOriginWithCredentialsUnsafe:true,
      allowCredentials: true,
      allowRequestHeaders: ['content-type', 'access-control-allow-origin', 'origin', 'authorization', 'user-agent', 'referer', 'accept', 'sec-ch-ua', 'sec-ch-ua-mobile', 'sec-ch-ua-platform', 'accept','x-signature'],
    },
  ...
  ***************************************************************************/
  custom: {
    baseUrl: 'https://crm.dobryicoffee.ru',
